...
from octis.models.contextualized_topic_models_neg.networks.inference_network import CombinedInferenceNetwork, ContextualInferenceNetwork
...
class DecoderNetwork(nn.Module):
    ...
    def forward(self, x, x_bert):
        ...
        return self.prior_mean, self.prior_variance, \
            posterior_mu, posterior_sigma, posterior_log_sigma, word_dist, topic_word, topic_doc, word_dist_neg
