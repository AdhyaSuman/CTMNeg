...
from octis.models.contextualized_topic_models_neg.datasets import dataset
from octis.models.contextualized_topic_models_neg.models import ctmn
from octis.models.contextualized_topic_models_neg.utils.data_preparation import bert_embeddings_from_list
...
class CTMN(AbstractModel):
    ...
    def __init__(self, num_topics=10, model_type='prodLDA', activation='softplus',
                 ...
                 prior_variance=None, hidden_sizes=(100, 100), use_partitions=True, num_samples=10,
    ...
    def train_model(self, dataset, hyperparameters=None, top_words=10, save_dir=None):
        ...
        if self.use_partitions:
            ...
            self.model = ctmn.CTMN(input_size=input_size, bert_input_size=x_train.X_bert.shape[1],
            ...
            self.model = ctmn.CTMN(input_size=input_size, bert_input_size=x_train.X_bert.shape[1], model_type='prodLDA',
                             num_topics=self.hyperparameters['num_topics'], dropout=self.hyperparameters['dropout'],
                             activation=self.hyperparameters['activation'], lr=self.hyperparameters['lr'],
                             inference_type=self.hyperparameters['inference_type'],
